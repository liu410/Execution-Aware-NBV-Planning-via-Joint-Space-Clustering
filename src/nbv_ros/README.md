...
![Dual-layer NBV pipeline](docs/images/pipeline_overview.png)
...
![Action-Mode clustering](docs/images/action_mode_clustering.png)
...
![Experimental platform and RViz visualization](docs/images/platform_rviz.png)
...
## Baseline and Experiment Scripts
...
For details, see [experiment/README.md](experiment/README.md).
...
This project is released under the MIT License. See the repository-level [LICENSE](../../LICENSE) file for details.
